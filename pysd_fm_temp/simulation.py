...
def run_sim(dm, hx, hz, temp):
  config = get_config(dm, hx*mRyToTesla, hz*mRyToTesla, temp)
...
if __name__ == "__main__":
  run_sim(float(sys.argv[1]), float(sys.argv[2]), float(sys.argv[3]), float(sys.argv[4]))
